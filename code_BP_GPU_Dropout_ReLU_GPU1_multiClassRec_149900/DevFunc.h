...
//__global__ void kernDevMergeCUDAout(int rows, int cols1, int cols2, float* out_vec1, float* out_vec2, float* out_vec);//mph183
//__global__ void kernDevSplitOut(int rows, int cols1, int cols2, float* in_vec, float* out_vec1, float* out_vec2);//mph183
...
//inline void DevMergeCUDAout(cudaStream_t stream, int rows, int cols1, int cols2, float* out_vec1, float* out_vec2, float* out_vec)
//{
//    int nblocks = (rows + NTHREADS-1)/NTHREADS;
//    if (nblocks > CUDA_MAXBLOCKS)
//			printf("DevMergeCUDAout: nblocks too large\n");
//    kernDevMergeCUDAout<<<nblocks, NTHREADS,0,stream>>>(rows, cols1, cols2, out_vec1, out_vec2, out_vec);
//}
//
//inline void DevSplitOut(cudaStream_t stream, int rows, int cols1, int cols2, float* in_vec, float* out_vec1, float* out_vec2)
//{
//    int nblocks = (rows + NTHREADS-1)/NTHREADS;
//    if (nblocks > CUDA_MAXBLOCKS)
//			printf("DevSplitOut: nblocks too large\n");
//    kernDevSplitOut<<<nblocks, NTHREADS,0,stream>>>(rows, cols1, cols2, in_vec, out_vec1, out_vec2);
//}
